    ...
    return (
        <div className="w-full md:h-[430px] py-[60px] flex justify-center max-lg:py-[40px] max-md:py-[24px]">
            <div className="w-[90%] max-w-[1120px]">
                <div className="text-center text-[28px] font-semibold text-[#444444] mb-6">Deals</div>
                ...
                <div className="w-full flex justify-center">
                    <Link href={'/deals'} className="w-[90px] h-[35px] text-white rounded-[37px] font-medium bg-[#005DB8] mt-6 cursor-pointer flex justify-center items-center">View all</Link>
                </div>
            </div>
        </div>
    )
