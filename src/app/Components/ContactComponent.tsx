  ...
  return (
    <div className="w-full flex justify-center py-[60px] max-lg:py-10 max-md:py-6 flex-wrap">
      <div className="w-[90%] max-w-[1120px]">
        <div className="w-full text-center text-[#444444] font-semibold text-[28px] max-md:text-[20px] pb-5">
          Email Us
        </div>
        <div className="w-full flex rounded-[24px] shadow-2xl max-lg:flex-wrap ">
          <div className="w-[30%] max-md:w-full bg-[#0262AC] rounded-[16px] text-white pt-10 px-[40px] max-sm:px-[10px]">
            <h1 className="py-[20px] font-semibold text-[22px] max-md:text-[18px]">
              CONTACT US
            </h1>
            ...
            <div className="flex flex-col gap-[40px] pt-[40px] max-md:text-[14px]">
              ...
              <div className="pl-[35px] pb-[70px]">
                <Link
                  href={"/locations"}
                  className="text-[14px]  border-b-[1px] "
                >
                  Open Map
                </Link>
              </div>
          ...
          <div className="py-6 px-10 max-md:px-5 w-[70%] max-md:w-full">
            ...
            <input
              ...
              onFocus={() => setRequiredData({ ...requiredData, email: false })}
              type="email"
              value={formData.email}
              onChange={(e) =>
                setFormData({ ...formData, email: e.target.value })
              }
              className="w-full h-10 outline-none border-[#9F9F9F] border-[1px] rounded-[8px] mt-2 px-4 mb-6"
            ></input>
            {requiredData.email && (
            ...
            <input
              ...
              type="text"
              onFocus={() => setRequiredData({ ...requiredData, name: false })}
              value={formData.name}
              onChange={(e) =>
            ...
            <label htmlFor="subject" className="font-semibold pt-6">
              Subject
            </label>
            <input
              id="subject"
              ...
              onFocus={() =>
                setRequiredData({ ...requiredData, subject: false })
              }
              onChange={(e) =>
            ...
            <label htmlFor="message" className="font-semibold pt-6">
              Message
            </label>
            <textarea
              id="message"
              ...
              onFocus={() =>
                setRequiredData({ ...requiredData, message: false })
              }
              onChange={(e) =>
                setFormData({ ...formData, message: e.target.value })
              }
              className="w-full min-h-[200px] outline-none border-[#9F9F9F] border-[1px] rounded-[8px] mt-2 p-4"
            ></textarea>
            ...
            <div className="w-full flex justify-center pt-6">
              <button
                onClick={onSubmit}
                className="w-[100px] h-[35px] rounded-[37px] text-white bg-[#0262AC]"
              >
                Submit
              </button>
            </div>
