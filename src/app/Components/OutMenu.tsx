  ...
  return (
    <div className="w-full bg-white py-[60px] max-md:py-6 flex justify-center">
      <div className="w-[90%] h-full max-w-[1120px] ">
        <div className="w-full text-center text-[#444444] text-[28px] font-semibold font-inter ">
          Our Menu
        </div>
        <div className="w-full  mt-[10px]  flex justify-center items-center flex-wrap gap-[40px]">
          {data.map((item, idx) => (
            <div
              key={idx}
              className="w-[22%] h-[45%] max-md:w-[40%] max-lg:pb-10 max-md:pb-6"
            >
              <a
              ...
              >
                <div className=" w-full h-full flex justify-center items-center flex-wrap cursor-pointer hover:transform hover:scale-110 transition-transform ease duration-300">
                  <Image
                    ...
                    className="w-[100px] h-[100px] mb-5 max-md:w-[80px] max-md:h-[80px]"
                  ></Image>
                  <div className="text-center w-full text-[#444444] font-semibold text-[20px] max-md:text-[16px]">
                    {item.text}
                  </div>
                </div>
              </a>
